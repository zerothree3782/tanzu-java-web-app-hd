SOURCE_IMAGE = os.getenv("SOURCE_IMAGE", default='private-harbor.tanzu.lab/tap/supply-chain/tanzu-java-web-app')
LOCAL_PATH = os.getenv("LOCAL_PATH", default='.')
NAMESPACE = os.getenv("NAMESPACE", default='default')
OUTPUT_TO_NULL_COMMAND = os.getenv("OUTPUT_TO_NULL_COMMAND", default=' > /dev/null ')

allow_k8s_contexts('tap-workload-01-admin@tap-workload-01')
